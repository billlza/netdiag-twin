...
pub trait Operator {
    ...
    bulk!(apply, bulk_apply, Self::Param, Self::Output);
}
...
pub trait CostFunction {
    ...
    bulk!(cost, bulk_cost, Self::Param, Self::Output);
}
...
pub trait Gradient {
    ...
    bulk!(gradient, bulk_gradient, Self::Param, Self::Gradient);
}
...
pub trait Hessian {
    ...
    bulk!(hessian, bulk_hessian, Self::Param, Self::Hessian);
}
...
pub trait Jacobian {
    ...
    bulk!(jacobian, bulk_jacobian, Self::Param, Self::Jacobian);
}
