        ...
        (
            ...
            json!({
                ...
                "recommendations": [
                    ...
                    {
                        "symptom": "none",
                        "action": "Verify what-if action with before/after telemetry before execution: reroute_path_b (Reroute to less-loaded path B)",
                        "effect": "Simulation is advisory; use lab verify-action after the change to prove observed impact.",
                        "risk": "low",
                        "confidence": 0.85,
                        "approval": true,
                        "hil": "unreviewed",
