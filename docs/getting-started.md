...
This guide describes the stable v0.5.1 platform contract for SRE and platform
...
Run the v0.5.1 reliability and benchmark gates:
...
NetDiag v0.5.1 can run a local OTLP Metrics gRPC receiver and wait for one
...
NetDiag v0.5.1 includes Rust-native packet capture support through `pcap` and
